...
urlpatterns = [
    ...
    # Public: recently changed rules (dashboard Rule Changes section)
    path("rules/changes/", RecentRuleChangesView.as_view(), name="rule-changes"),
    ...
    path("rules/<str:rule_id>/impact/", AdminRuleImpactView.as_view(), name="rule-impact"),
