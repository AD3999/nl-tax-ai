...
from .views import (
    ...
    AccountantInboxView, FileTaxReturnView, RejectTaskView,
...
urlpatterns = [
    ...
    path("engagements/<int:pk>/file/",                  FileTaxReturnView.as_view(),        name="portal-file-return"),
    path("engagements/<int:pk>/reject-task/",           RejectTaskView.as_view(),           name="portal-reject-task"),
