...
CHECKLISTS: Dict[str, List[Dict[str, Any]]] = {
    ...
    "zzp": [
        {"stable_key": "zzp_kvk",               "title": "KVK number",                          "description": "Chamber of Commerce registration number",                          "category": "identity",   "required": True,  "priority": "high"},
        {"stable_key": "zzp_btw",               "title": "BTW (VAT) number",                    "description": "OB-nummer for VAT returns",                                        "category": "identity",   "required": True,  "priority": "high"},
        {"stable_key": "zzp_start_date",        "title": "Business start date",                 "description": "Date of KVK registration / business start",                       "category": "identity",   "required": True,  "priority": "high"},
        {"stable_key": "zzp_revenue",           "title": "Annual revenue (total invoiced)",     "description": "Total turnover for the tax year — all client invoices",           "category": "income",     "required": True,  "priority": "high"},
        ...
        {"stable_key": "zzp_hours",             "title": "Hours registration (urencriterium)",  "description": "1,225+ hours required for zelfstandigenaftrek — log or summary",  "category": "compliance", "required": True,  "priority": "high"},
        ...
        {"stable_key": "zzp_wet_dba_clients",   "title": "Wet DBA — number of clients",         "description": "How many clients worked with, % from largest client",            "category": "compliance", "required": True,  "priority": "high"},
    ...
    "expat": [
        ...
        {"stable_key": "exp_start_date",         "title": "Start date in the Netherlands",      "description": "Date of first arrival / work start in NL",                       "category": "identity",   "required": True,  "priority": "high"},
        {"stable_key": "exp_prev_country",       "title": "Previous country of residence",      "description": "Country of tax residency before moving to NL",                   "category": "identity",   "required": True,  "priority": "high"},
    ...
    "dga": [
        ...
        {"stable_key": "dga_shareholding",       "title": "Shareholding percentage",            "description": "DGA's % in the BV (≥5% = AB-houder for Box 2)",                 "category": "box2",       "required": True,  "priority": "high"},
        {"stable_key": "dga_salary",             "title": "DGA salary (gebruikelijk loon)",     "description": "Actual salary paid by BV — minimum €56,000 in 2026",            "category": "income",     "required": True,  "priority": "high"},
        ...
        {"stable_key": "dga_gebruikelijk_loon",  "title": "Gebruikelijk loon check",            "description": "Confirm DGA salary meets €56,000 minimum or has waiver",        "category": "compliance", "required": True,  "priority": "high"},
    ],
